...
- **The discipline is the deliverable.** Every confirmatory claim is pre-registered with a git-provable freeze-then-result gap, variance-reduced, and reported whichever way it fell. §13 is the proof the discipline works on a negative (the protocol returned the opposite of the hypothesis); §14 is the proof it works on a positive.
